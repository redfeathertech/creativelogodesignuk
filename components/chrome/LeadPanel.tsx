...
export function useLeadPanel(): LeadPanelApi {
    ...
    if (!ctx)
        throw new Error("useLeadPanel must be used inside <LeadPanelProvider>");
    return ctx;
}
    ...
    return (
        <LeadPanelContext.Provider value={{ open, close }}>
            ...
            <div
                ...
                {...(!isOpen && { inert: false })}
                className={cn(
                    "fixed top-0 right-0 z-[1045] flex h-dvh w-full max-w-[570px] flex-col",
                ...
                <div className="flex items-start justify-between gap-4 border-b border-white/10 p-6 sm:p-8">
                    <div>
                        ...
                        <p className="mt-1.5 text-sm text-white/60">
                            Digital experiences that have driven growth since
                            1998.
                        </p>
                    </div>
                    <button
