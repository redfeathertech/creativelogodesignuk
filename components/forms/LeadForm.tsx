                ...
                <fieldset className="col-span-full m-0 border-0 p-0">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {HELP_OPTIONS.map((option) => (
                            <label
                                key={option}
                                className="cursor-pointer rounded-full border border-white/[0.11] bg-origin-border px-4 py-2 text-sm text-white/70 transition-colors hover:border-white/25 has-checked:border-transparent has-checked:bg-[linear-gradient(97deg,var(--color-magenta-500)_0%,var(--color-violet-500)_100%)] has-checked:text-white"
                            >
                                <input
                                    type="checkbox"
                                    name="help"
