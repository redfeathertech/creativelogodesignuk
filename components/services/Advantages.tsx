    ...
    <Section tone="darker">
      <div className="container-site grid items-center gap-[clamp(2.5rem,1.5rem+5vw,4.5rem)] lg:grid-cols-2">
        <div className="reveal">
          ...
          <SectionHeading lead={data.heading} accent={data.headingAccent} />
          <p className="mt-6 max-w-[62ch] text-lead text-white/65">{data.lead}</p>
              ...
              <div key={stat.label}>
                ...
                <dd>
                  ...
                  <p className="gradient-text font-display text-h3 leading-none font-extrabold break-words">
                    {stat.prefix}
                    <Counter value={stat.count} suffix={stat.suffix} className="inline" />
                  </p>
        ...
        <div className="reveal">
          <Image
            ...
            className="mx-auto h-auto w-full max-w-[480px] rounded-lg shadow-lg"
          />
        </div>
      </div>
    </Section>
