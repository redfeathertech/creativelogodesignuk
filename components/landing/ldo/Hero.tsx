...
import { hero } from "@/content/landing/logo-design-offer";
 ...
 *
 * The live `<h1>` reads "Bespoke Logo Design Starts from" and stops there: the
 * price that finishes the sentence is `price.webp`, a bitmap with "£19" painted
 * into it. So on the live page the headline offer — the number the entire ad
 * spend is bidding on — is invisible to a crawler and silent to a screen reader.
 * It is HTML here, inside the same `<h1>`.
 */
    ...
    return (
        <section className="relative isolate overflow-hidden bg-ink-950 text-white">
            ...
            <div className="container-site grid items-center gap-[clamp(2.5rem,1.5rem+5vw,4.5rem)] py-[clamp(2.5rem,1rem+5vw,4.5rem)] lg:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]">
                <div className="reveal">
                    <h1 className="text-h1">
                        ...
                        <span className="block">
                            {hero.titleTrail}{" "}
                            <span className="gradient-text">{hero.price}</span>
                        </span>
                    </h1>
                ...
                <div className="reveal rounded-lg border border-white/10 bg-ink-850/80 p-6 shadow-lg backdrop-blur-md sm:p-8">
