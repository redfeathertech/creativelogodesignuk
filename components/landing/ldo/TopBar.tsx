...
import { topBar } from "@/content/landing/logo-design-offer";
 ...
 * from `app/(site)/`.
 *
 * The live page marks the offer line up as an `<h6>`, which is why its heading
 * outline starts at level 6 and then jumps to the `<h1>` below it. It is a
 * paragraph here — same words, and the outline is no longer broken before the
