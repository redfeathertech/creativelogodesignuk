 ...
 *
 * The intro column is pinned while the steps scroll past it — the two halves
 * are read together, not one after the other.
 *
                ...
                <div className="grid items-start gap-[clamp(2.5rem,1.5rem+5vw,5rem)] lg:grid-cols-[minmax(0,5fr)_minmax(0,6fr)]">
                    <div className="reveal lg:sticky lg:top-32">
                        ...
                        {/* <Image
                            ...
                            height={300}
                            sizes="340px"
                            className="mt-8 h-auto w-full max-w-[340px] drop-shadow-[0_22px_44px_rgb(204_6_127/0.32)]"
                        /> */}
                    </div>
