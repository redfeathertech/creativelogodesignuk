...
export const serviceNav: NavGroup[] = [
    ...
    },
    {
        ...
        items: [
            { label: "E-commerce", href: "/web-development-services/ecommerce" as Route },
            { label: "WordPress", href: "/web-development-services/wordpress" as Route },
            { label: "Shopify Developers", href: "/web-development-services/shopify" as Route },
            { label: "Magento", href: "/web-development-services/magento" as Route },
            { label: "Laravel", href: "/web-development-services/laravel" as Route },
            { label: "Contentful", href: "/web-development-services/contentful" as Route },
            { label: "AMP", href: "/web-development-services/amp" as Route },
            { label: "Page Speed", href: "/web-development-services/page-speed-optimisation" as Route },
