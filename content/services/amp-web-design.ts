...
export const ampWebDesignOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "AMP web design from Creative Logo Design — lightweight Accelerated Mobile Pages that load instantly, rank better on mobile and keep visitors from leaving."
  },
  "hero": {
