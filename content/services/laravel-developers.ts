...
export const laravelDevelopersOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "Laravel development from Creative Logo Design — custom web applications, APIs and integrations built secure, fast and ready to scale with your business."
  },
  "hero": {
