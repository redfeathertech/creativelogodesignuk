...
export const custom3dProductConfiguratorsOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "Custom 3D product configurators from Creative Logo Design — let shoppers rotate, customise and preview your products in real time, so more of them buy."
  },
  "hero": {
