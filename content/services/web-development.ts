...
export const webDevelopmentOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "Web development from Creative Logo Design — fast, secure, custom-built websites that load quickly, integrate with your systems and scale as your business grows."
  },
  "hero": {
