...
export const contentManagementSystemsOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "Bespoke content management systems from Creative Logo Design — custom CMS builds that simplify publishing and put control of your website in your hands."
  },
  "hero": {
    ...
    "mediaAlt": "Content Management Systems services from Creative Logo Design",
    "ctaPrimary": "Hire us",
