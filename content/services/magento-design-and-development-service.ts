...
export const magentoDesignAndDevelopmentOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "Magento web design and development from Creative Logo Design — fast, custom eCommerce stores that attract shoppers, convert them and grow with your business."
  },
  "hero": {
