...
export const wordpressDevelopmentOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "WordPress development from Creative Logo Design — custom, secure sites that are easy to manage, quick to load and built to grow with your business."
  },
  "hero": {
