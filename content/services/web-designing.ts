...
export const webDesigningOverrides: ServiceContentOverrides = {
  "meta": {
    "title": "Web Designing",
    "description": "Web design from Creative Logo Design — websites that look great, feel right and work hard for your business, turning visitors into customers who come back."
  },
  "hero": {
    "eyebrow": "Web Design",
