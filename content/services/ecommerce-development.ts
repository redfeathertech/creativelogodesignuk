...
export const ecommerceDevelopmentOverrides: ServiceContentOverrides = {
  "meta": {
    ...
    "description": "E-commerce website development from Creative Logo Design — secure, scalable online stores with smooth checkout, built to turn browsers into paying customers."
  },
  "hero": {
